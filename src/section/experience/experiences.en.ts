...
const experiences: Experience[] = [
  {
    title: 'Freelancer', start: 2017, end: null, subtitle: 'Marseille, France', description: 'Certified and passionate software engineer, I am expert in the development of web applications and websites (high volume sites, intranets, CRMs). I support you in the realization of your project from its conception to its delivery.<br />Being an entrepreneur since 2017, I had the opportunity to collaborate with a large number of clients including fortune 50 companies (pfizer …) in their digital transformations.<br />I have a real interest in user ergonomics, optimization and quality of the application in accordance with good practices.', logo: 'freelance.png', company: 'freelance',
  },
  {
  ...
  },
  {
    ...
    highlights: [
      {
        title: 'Third year',
        content: ['Development of advanced software (applications, video games) in C, C++', 'Networking (socket, VOIP)', 'Threading', 'AI', 'Software architecture', 'Programmation web', 'Functionnal programming using OCAML'],
      },
      {
        title: 'Second year',
        content: ['Development of software (algorithms, video games) in C, C++', 'Threading', 'Networking (socket)', 'GUI', 'Sofware architecture'],
      },
      {
        title: 'First year',
