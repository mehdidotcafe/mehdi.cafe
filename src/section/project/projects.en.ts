...
const projects: Project[] = [
  ...
  },
  {
    ...
    description_project: 'Louis Vuitton is a French luxury brand.\nDevelopment of a Backend-for-Frontend API within a microservices architecture powering the brand\'s mobile e-commerce applications.',
    description_mission: [
      'Development of “Store mode”, a unique in-store experience based on a QR Code scan',
      'Development of a virtual waiting room system to manage traffic spikes during major marketing events (product launches, drops, etc.)',
  ...
  },
  {
    ...
    description_project: 'Coinbasket, ASI Alliance x BNB AI Hackathon prize winner, is an AI-powered portfolio builder designed to simplify and personalize crypto investing. By combining natural language processing, on-chain agents, and real-time market data, coinbasket enables you to create and manage thematic crypto portfolios with just a prompt.',
    description_mission: [
      'Development of the platform including the front-end, back-end',
      'Development of wallet and on-chain interaction systems',
      'Integration of the Fetch.ai uagents framework and 0x Protocol SWAP API',
    ],
    recommendations: [],
    start: '2025-05-01',
    end: '2026-12-31',
